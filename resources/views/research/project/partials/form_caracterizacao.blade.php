...
<div class="row">
    <div class="col-sm-5">
        <a class="btn btn-default btn-sm" href="#div2"><i class="glyphicon glyphicon-chevron-left"> Voltar</i></a>
    </div>
    ...
    <div class="col-sm-2 text-right">
        <a class="btn btn-default btn-sm" href="#div4">Avançar <i class="glyphicon glyphicon-chevron-right"></i></a>
    </div>
</div>